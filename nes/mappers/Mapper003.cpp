...
void Mapper003::GetAdditionalState(std::shared_ptr<MapperAdditionalState> state) const {}

void Mapper003::LoadAdditionalState(std::shared_ptr<MapperAdditionalState> state) {}
